(function (global, factory) {
  ...
  function Relsa(a){var b=Math.floor,c=this,d={container:".relsa-container",render:4,startIndex:1,customDotClassName:"",isResponsive:!0};return a.render&&(a.render=b(a.render)),a.startIndex&&(a.startIndex=b(a.startIndex)),this.options=a instanceof Object?extend(d,a):d,1>this.options.render&&(this.options.render=1),(this.options.startIndex>this.options.render||1>this.options.startIndex)&&(this.options.startIndex=1),this.generateProportions=function(){// create array
